...
export default function Home() {
  return (
    ...
    <main className="flex flex-col py-5 lg:flex-col   ">
      ...
      <div className="flex flex-col justify-center text-center lg:flex-row lg:justify-between  w-full py-10 ">
        ...
        <div className=" flex flex-col justify-center text-center">
            ...
            <div className=" text-3xl lg:text-4xl font-black whitespace-nowrap py-10 text-transparent bg-clip-text bg-gradient-to-r from-teal-300 to-violet-500 ">
            A Full stack developer 
            </div>
            <div className=" text-2xl lg:text-3xl text-gray-400">
            I build things sometimes  
            </div>
        </div>

        <Image
        className="rounded-full w-28 lg:w-52 mx-auto m-4"
        src={pfpPic}
        alt="pfp picture"
